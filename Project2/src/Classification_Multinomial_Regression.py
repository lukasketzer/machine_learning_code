...
class ClassificationMultinomialRegression:
    def __init__(self, X, y, l = 10):
        self.X = X
        self.Y = y
        self.l = l
        self.logreg = LogisticRegression(
            C=1.0 / l,  # Set C as the inverse of lambda
...
if __name__ == "__main__":
    ...
    for outer_fold_idx, (train_idx, test_idx) in enumerate(outer_cv.split(X), start=1):
        ...
        for lambda_value in lambda_values:
            ...
            for inner_fold_idx, (inner_train_idx, inner_val_idx) in enumerate(inner_cv.split(X_train_outer), start=1):
                ...
                with warnings.catch_warnings():
                    ...
                    mod = ClassificationMultinomialRegression(X_train_inner, y_train_inner, lambda_value)
                ...
                y_val_pred = mod.predict(X_val_inner)
        ...
        with warnings.catch_warnings():
            ...
            mod = ClassificationMultinomialRegression(X_train_outer, y_train_outer, best_lambda)
        
        # Evaluate on the outer test set
        y_test_outer_pred = mod.predict(X_test_outer)
